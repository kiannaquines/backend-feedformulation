...
@nutrient_requirements_router.put('/nutrient-requirements/update/{nutrient_requirement_id}', status_code=status.HTTP_200_OK)
...
@nutrient_requirements_router.delete('/nutrient-requirements/delete/{nutrient_requirement_id}', status_code=status.HTTP_200_OK)
