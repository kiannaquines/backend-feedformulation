...
class NutrientComposition(BaseModel):
    protein_percent: float = Field(..., ge=0, description="Crude protein percentage")
    energy_me: float = Field(..., ge=0, description="Metabolizable energy (Mcal/kg)")
    calcium_percent: float = Field(..., ge=0, description="Calcium percentage")
    phosphorus_percent: float = Field(..., ge=0, description="Phosphorus percentage")
